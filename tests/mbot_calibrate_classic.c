...
int main() {
    ...
    params.intercept_pos[mot_right] = b_rp;
    params.intercept_pos[mot_left] = b_lp;
    params.intercept_neg[mot_right] = b_rn;
    params.intercept_neg[mot_left] = b_ln;
